...
<div className="dropdown-left">
  <button className="btn colorbtn-secondary dropdown-toggle btnfontcolor" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Products
  </button>
